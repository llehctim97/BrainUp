...
class OnsenModuleInjector extends import0.NgModuleInjector<import1.OnsenModule> {
  ...
  get _AlertDialogFactory_30():import19.AlertDialogFactory {
    if ((this.__AlertDialogFactory_30 == null)) { (this.__AlertDialogFactory_30 = new import19.AlertDialogFactory(this,this,this._ApplicationRef_10,this._ComponentLoader_29,this.parent.get(import27.NgZone))); }
    return this.__AlertDialogFactory_30;
  }
  get _PopoverFactory_31():import20.PopoverFactory {
    if ((this.__PopoverFactory_31 == null)) { (this.__PopoverFactory_31 = new import20.PopoverFactory(this,this,this._ApplicationRef_10,this._ComponentLoader_29,this.parent.get(import27.NgZone))); }
    return this.__PopoverFactory_31;
  }
  get _DialogFactory_32():import21.DialogFactory {
    if ((this.__DialogFactory_32 == null)) { (this.__DialogFactory_32 = new import21.DialogFactory(this,this,this._ApplicationRef_10,this._ComponentLoader_29,this.parent.get(import27.NgZone))); }
    return this.__DialogFactory_32;
  }
  get _ModalFactory_33():import22.ModalFactory {
    if ((this.__ModalFactory_33 == null)) { (this.__ModalFactory_33 = new import22.ModalFactory(this,this,this._ApplicationRef_10,this._ComponentLoader_29,this.parent.get(import27.NgZone))); }
