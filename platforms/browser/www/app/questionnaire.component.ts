...
export class QuestionnaireIntro {
  ...
  constructor(injector: Injector, dataService: DataService, hairstyleService: HairstyleService, glassesService: GlassesService, shirtService: ShirtService, pantsService: PantsService, shoesService: ShoesService, watchService: WatchService, outfitService: OutfitService) {
