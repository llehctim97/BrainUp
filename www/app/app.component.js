...
var AppComponent = /** @class */ (function () {
    function AppComponent(dataService, cordovaService) {
        var _this = this;
        this.page = null;
        this.instance = null;
        ...
        dataService.saveEvent('app_opened').then(function () {
            _this.gotoPage(nback_component_1.SplashScreen, null);
        });
    ...
    AppComponent = __decorate([
        core_1.Component({
            ...
            template: "<div id=\"overlay\"><p id=\"text\">Geen internet verbinding</p></div>\n             <dynamic-component [componentData]=\"page\" [parent]=\"instance\"></dynamic-component>"
        }),
        __metadata("design:paramtypes", [dataService_1.DataService, cordovaService_1.CordovaService])
    ], AppComponent);
    return AppComponent;
}());
